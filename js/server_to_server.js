...
const main = new Vue({
  ...
  methods: {
    ...
    /**
     * append the string "test_transaction_" then get the currect date and time to act as unique identifier
     * @returns time-based (milisecond) transaction ID
     */
    ...
    axios
      ...
      .finally(() => {
        ...
        this.basic.parameters.push(
          `merchantTransactionId=${this.generate_transaction_id()}`,
