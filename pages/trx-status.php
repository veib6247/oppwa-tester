...
<body>
  ...
  <!-- hero -->
  <section class="hero is-primary" style="background-image: url(../src/images/pekora.png); background-position: center;">
    <div class="hero-body">
      <div class="container">
      ...
      <div class="notification is-size-7">
        <div class="columns">
          ...
          <div class="column">
            ...
            <div class="field">
              <div class="control">
                <a href="copy-and-pay.php" class="button is-primary is-small">Submit Another Request</a>
              </div>
            </div>
          </div>
        </div>
